  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo" ><b>MyFreeTeamSpeak</b></a>
            <!--logo end-->
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended tasks-bar">
                            ...
                            <li>
                                <a href="index.html#">
                                    <div class="task-info">
                                        <div class="desc">MyFreeTeamSpeak Admin Panel</div>
...
?>
		...
		<!--<pre><?php
			...
			?></pre> -->
			<pre>
			<?php $tokenlist = \Fr\LS::tokenList();
print_r($tokenlist);			?> </pre>
